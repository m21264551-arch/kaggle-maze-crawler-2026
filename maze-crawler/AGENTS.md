...
For competition strategy work, read `COMPETITION_PROMPT.md` first. It points to
`CURRENT_STRATEGY.md` as the steering wheel and `patchnotes.md` as the evidence
log.
